<?php
    class OutsideUserD extends OutsideUserAbstract
    {
        public function save()
        {
            if( false === $this->is_cached )
            {
                ...
                if( !empty( $values ) )
                {
                    ...
                    else
                    {
                        ...
                        @Tools::report( Db::i()->displayLastQuery(), 'Della Import User Error' );
                    }
                }
            }
            ...
            if( 'freight' == $this->section )
            {
                ...
                else
                {
                    ...
                    {
                        User::truncatePhones( $this->id, $this->contact_person, $this->lang );       // TODO Прибрати
