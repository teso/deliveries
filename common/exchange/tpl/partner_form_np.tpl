<div class="hide">
    <form id="partner_form_np" class="partner_form">
        ...
        <div class="clearfix">
            <dl>
                ...
                <dd class="<?=(empty( $braches_from ) && empty( $braches_to ) ? 'hide' : '')?>">
                    <div class="<?=(empty( $braches_from ) || empty( $braches_to ) ? 'hide' : '')?>">
                        <label>
                            <input name="service" value="4" type="radio" />&nbsp;<?=l('partner_storage1', 'el')?> - <?=l('partner_storage2', 'el')?>
                        </label>
                    </div>
                    <div class="<?=(empty( $braches_from ) ? 'hide' : '')?>">
                        <label>
                            <input name="service" value="3" type="radio" />&nbsp;<?=l('partner_storage1', 'el')?> - <?=l('partner_home2', 'el')?>
                        </label>
                    </div>
                    <div class="<?=(empty( $braches_to ) ? 'hide' : '')?>">
                        <label>
                            <input name="service" value="2" type="radio" />&nbsp;<?=l('partner_home1', 'el')?> - <?=l('partner_storage2', 'el')?>
                        </label>
                    </div>
                    <div>
                        <label>
                            <input name="service" value="1" type="radio"<?=(empty( $braches_from ) && empty( $braches_to ) ? ' checked="checked"' : '')?> />&nbsp;<?=l('partner_home1', 'el')?> - <?=l('partner_home2', 'el')?>
                        </label>
                    </div>
                </dd>
                <dt>
                ...
                <dd class="ss0 hide">
                    <select name="branch_from">
                        ...
                        <option value="<?=$b['number']?>"><?=$b['address']?></option>
                        <? endforeach; ?>
                    </select>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    <label>
                        <input name="payer" value="1" type="radio" />&nbsp;<?=l('partner_sender', 'el')?>
                    </label>
                    <label>
                        <input name="payer" value="0" type="radio" />&nbsp;<?=l('partner_receiver', 'el')?>
                    </label>
                </dd>
                <dt>
                ...
                <dd>
                    <label>
                        <input name="payform" value="1" type="radio" />&nbsp;<?=l('partner_cash', 'el')?>
                    </label>
                    <label>
                        <input name="payform" value="2" type="radio" />&nbsp;<?=l('partner_cashless', 'el')?>
                    </label>
                </dd>
                <dt>
        ...
        <div class="center">
            <button onclick="PartnerApi.check_form(<?=$record_data['id']?>, 'np');" class="button button_middle partner_submit" type="button"><?=l('partner_submit', 'el')?></button>
        </div>
    </form>
</div>